...
if True:
    ...
    np.savetxt("comparison_new_2000_01.csv", ds_01, delimiter=",")
    np.savetxt("comparison_new_2000_02.csv", ds_02, delimiter=",")
    np.savetxt("comparison_new_2000_03.csv", ds_03, delimiter=",")
    np.savetxt("comparison_new_2000_04.csv", ds_04, delimiter=",")
    np.savetxt("comparison_new_2000_05.csv", ds_05, delimiter=",")
    np.savetxt("comparison_new_2000_06.csv", ds_06, delimiter=",")
    np.savetxt("comparison_new_2000_07.csv", ds_07, delimiter=",")
    np.savetxt("comparison_new_2000_08.csv", ds_08, delimiter=",")
    np.savetxt("comparison_new_2000_09.csv", ds_09, delimiter=",")
    np.savetxt("comparison_new_2000_10.csv", ds_10, delimiter=",")
    np.savetxt("comparison_new_2000_15.csv", ds_15, delimiter=",")
    np.savetxt("comparison_new_2000_16.csv", ds_16, delimiter=",")
    np.savetxt("comparison_new_2000_17.csv", ds_17, delimiter=",")
